...
#
  git tag -a v2023.8.0 -m "v2023.8.0"
...
Then:
  ...
  git commit -am "New version 2023.8.0"
  git commit --allow-empty -m "New version 2023.8.0"
  git commit -am "Prepare new version 2023.8.0"
  git commit -am "Latest files of version 2023.8.0"
